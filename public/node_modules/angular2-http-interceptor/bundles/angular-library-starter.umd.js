(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('@angular/core'), require('@angular/http')) :
	typeof define === 'function' && define.amd ? define(['exports', 'rxjs', '@angular/core', '@angular/http'], factory) :
	(factory((global.ng = global.ng || {}, global.ng['angular-library-starter'] = global.ng['angular-library-starter'] || {}),global.rxjs,global.ng.core,global._angular_http));
}(this, (function (exports,rxjs,_angular_core,_angular_http) { 'use strict';
...
var HttpInterceptorBackend = (function () {
    ...
    HttpInterceptorBackend.prototype.createConnection = function (request) {
        var /** @type {?} */ reqObs = rxjs.Observable.of(request);
        var _loop_1 = function(interceptor) {
            ...
            reqObs = reqObs.mergeMap(function (req) {
                ...
                return nextReq instanceof rxjs.Observable ? nextReq : rxjs.Observable.of(nextReq);
            });
        };
...
function httpFactory(httpInterceptorBackend, requestOptions) {
    return new _angular_http.Http(httpInterceptorBackend, requestOptions);
}
/**
 * @return {?}
 */
function createDefaultCookieXSRFStrategy() {
    return new _angular_http.CookieXSRFStrategy();
}
/**
    ...
    HttpInterceptorModule.withInterceptors = function (interceptors) {
        return {
            ...
            providers: interceptors.concat([
                {
                    deps: [HttpInterceptor, _angular_http.XHRBackend],
                    provide: HttpInterceptorBackend,
                    useClass: HttpInterceptorBackend,
                },
                {
                    deps: [HttpInterceptorBackend, _angular_http.RequestOptions],
                ...
                _angular_http.BrowserXhr,
                {
                    ...
                    useClass: _angular_http.BaseRequestOptions
                },
                {
                    provide: _angular_http.ResponseOptions,
                    useClass: _angular_http.BaseResponseOptions
                },
                _angular_http.XHRBackend,
                {
                    provide: _angular_http.XSRFStrategy,
...
exports.HttpInterceptorBackend = HttpInterceptorBackend;
exports.HttpInterceptorConnection = HttpInterceptorConnection;
